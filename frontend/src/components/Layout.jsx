  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 ml-64 flex flex-col transition-all duration-300">
        <header className="sticky top-0 z-10 bg-white border-b border-gray-200 h-16 flex items-center px-8 justify-between">
          <h1 className="text-lg font-semibold text-gray-800 capitalize">
            {location.pathname === '/' ? 'Overview' : location.pathname.substring(1)}
          </h1>
          <div className="flex items-center gap-4">
            <span className="text-xs font-medium text-gray-400 px-2 py-1 bg-gray-100 rounded">v0.1.0</span>
          </div>
        </header>
